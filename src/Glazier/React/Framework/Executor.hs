...
type instance P.PUnary (Executor m) c = Executor m c

instance Applicative m => P.PPointed (Executor m) (Which '[]) where
    ppure = pure
...
instance ( Applicative m
         ...
         P.PApplicative (Executor m) (Which a) (Which b) (Which c) where
...
instance ( Monad m
         ...
         P.PMonad (Executor m) (Which a) (Which b) (Which c) where
    pbind (Executor x) k =
        Executor $ \cs ->
            let lcs = foldMap lgo cs
                rcs = foldMap rgo cs
